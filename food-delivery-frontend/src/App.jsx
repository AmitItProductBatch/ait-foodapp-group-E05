...
const getApiBaseUrl = () => {
  ...
  return `http://${hostname}:8085/api/users`
}
        ...
        <footer className="footer">
          <div className="info-chips">
            <div className="chip">
              ...
              <span className="chip-val">Port 4005 (React + Vite)</span>
            </div>
            <div className="chip">
              <span className="chip-label">Backend</span>
              <span className="chip-val">Port 8085 (Spring Boot 3)</span>
            </div>
            <div className="chip">
              <span className="chip-label">Database</span>
              <span className="chip-val">Port 5005 (PostgreSQL 16)</span>
            </div>
            <div className="chip">
